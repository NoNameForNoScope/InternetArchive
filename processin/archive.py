...
def main():
    ...
    parser.add_argument("-d", "--depth", type=int, default=2)  # doar la mod domain
    parser.add_argument("-w", "--wordlist", default="wordlist.txt")  # tot doar la domain, momentan neintegrat
